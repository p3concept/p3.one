                ...
                if(FusionShortcodes.dev == 'true') {
	                ...
	                btn.onRenderMenu.add(function (c, b)
					{
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_blog',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[blog number_posts="10" cat_slug="" exclude_cats="" title="yes" thumbnail="yes" excerpt="yes" excerpt_words="35" meta_all="yes" meta_author="yes" meta_categories="yes" meta_comments="yes" meta_date="yes" meta_link="yes" paging="yes" scrolling="pagination" blog_grid_columns="3" strip_html="yes" layout="large"][/blog]');
                            }
                        });
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_full',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[fullwidth menu_anchor="" backgroundcolor="" backgroundimage="" backgroundrepeat="no-repeat" backgroundposition="top left" backgroundattachment="scroll" bordersize="1px" bordercolor="" paddingTop="20px" paddingBottom="20px"]...[/fullwidth]');
                            }
                        });
                        ...
                        a.addImmediate({
                            title : 'Menu Anchor',
                            icon: 'fusion_menuanchor',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[menu_anchor name=""]');
                            }
                        });
                        a.addImmediate({
                            title : 'Person',
                        ...
                        a.addImmediate({
                            ...
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[section_separator divider_candy="bottom or top or bottom,top" icon="" icon_color="" bordersize="" bordercolor="" backgroundcolor=""]');
                            }
                        });                         
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_separator',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[separator top="40" bottom="" style="none, single, double, dashed, dotted, shadow"]');
                            }
                        });
